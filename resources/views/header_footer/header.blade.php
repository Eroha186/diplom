	...
	<div class="header-top">
		<div class="container">
			<nav class="row header-top__nav">
				<ul class="{{(request()->is('login') || request()->is('register')) ? 'col-md-8' : 'col-md-10'}} header-top__nav-items">
				...
				@if((request()->is('login') || request()->is('register')))
					<a class="header-top__nav-button col-md-2 transparent-btn ta-center" href="/login">Авторизация</a>
					<a class="header-top__nav-button col-md-2 transparent-btn  ta-center" href="register">Регистрация</a>
				@endif
				@if(!(request()->is('login') || request()->is('register')))
