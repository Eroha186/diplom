	...
	<div class="header-top">
		<div class="container">
			<nav class="row header-top__nav">
				<ul class="{{!(\Illuminate\Support\Facades\Auth::check() || Cookie::get('admin') == 1) ? 'col-xl-10'  : 'col-xl-8'}} header-top__nav-items">
				...
				@if(Cookie::get('admin') == 1)
					<a class="header-top__nav-button col-xl-2 transparent-btn ta-center" href="/admin">Админка</a>
				@endif
			</nav>
		</div>
	</div>
