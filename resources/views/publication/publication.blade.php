        ...
        <div class="row">
            <div class="col-xl-9">
                ...
                <div class="publication-content__viewport">
                  ...
                  @foreach ($publication->files as $property)
                  @if($property->type == 'ppt')
                  <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=https://sovped.ru/storage/{{$property->url}}' width='100%' height='600px' frameborder='0'> </iframe>
                    @endif
                    @endforeach
                    @endif                
                         ...
                         <div class="publication-content__text mt-3" id="readable">
