    ...
    <div class="contents__wrapper">
      ...
      <div class="row justify-content-center">
        <div class="col-md-6 contents__descr">
          <p class="ta-center margin-bottom-0">Мероприятия проводятся на конкурсной основе. Вы можете участвовать как с
  ...
  <div id="tabs">
    ...
    <div class="tab-content content_active tab-section" data-tab="1">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 contents__descr">
            <p class="ta-center margin-bottom-0">Мероприятия проводятся на конкурсной основе. Вы можете участвовать как
        ...
        @foreach ($publications as $publication)
            <div class="publication">
              ...
              <div class="publication__descr">
                ...
                <div class="author">
                  {{$publication->f}}, {{$publication->stuff}}
                </div>
              </div>
            </div>
        @endforeach
...
<section class="main-page__winner">
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="winner__desr ta-center">Более 1234 педагогов опубликовались на нашем сайте за последние 2 года.
